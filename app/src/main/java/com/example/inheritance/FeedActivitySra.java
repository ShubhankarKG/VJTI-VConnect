...
public class FeedActivitySra extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feed_sra);
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("SRA");
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    adapter = new Adapter(FeedActivitySra.this, postList);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(FeedActivitySra.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                progressCircle.setVisibility(View.INVISIBLE);
        ...
        fabAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent addPost = new Intent(FeedActivitySra.this, AddPost.class);
                addPost.putExtra("adminOf", "SRA");
